...
# select data
DATA_PATH = '../../../data/livingroom/'

if RESTORE_TRAINED_MODEL:
   RESTORE_LOGS_DIR = "../../../model/saved_models-lmf-fs/select/" 


startSceneIDX = 359 # index of the starting scene for test
endSceneIDX = 359 # index of the last scene
...
focal_stack, numScenes, numTrainSamples, numEvalSamples, cleanRGB, depth, diopter, kernel_width, validSceneIdxList = \
    loadData(DATA_PATH, RENORM_SCALE, \
              N,M,H,W,imH,imW,dp_focal,dp_display,fov,D,startSceneIDX,endSceneIDX,numEvalScenes,C, depthScale, diopterScale, LOAD_FS, LOAD_RGBD, GLOBAL_SCALE)
